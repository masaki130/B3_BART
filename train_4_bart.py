...
# # BARTモデルの学習(ファインチューニング), これは没

# In[ ]:


from transformers import PreTrainedTokenizerFast
tokenizer = PreTrainedTokenizerFast(tokenizer_file="tokenizer_3.json", 
...
model = BartForConditionalGeneration.from_pretrained("./models/g2p_prosody_bart/checkpoint-38500/")     # 変更済み
...
dataset_all = Dataset.from_json("all_4.json")

# 実際に使うデータセットをここで指定する
# dataset_sub = dataset_all
dataset_sub = dataset_all     # 学習回数を変更5000→
dataset_dict = Dataset.train_test_split(dataset_sub, test_size=0.1)     # 11111
...
output_model_path = "./trained_bart_model_4"
